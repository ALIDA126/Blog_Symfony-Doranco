...
class ArticleType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            ...
            /**
             * on rajoute 'allow_file_upload' (une clef d'une paire($key =>$value) dans un array) qui est un parametre symfony
             * qu'on definit a true
             * Cela permet d'organiser notre formulaire a importer des fichiers => revient a <form enctype=multipart/form-data>
 
             */
            'allow_file_upload' => true, //On decommente cette ligne pour autoriser un upload de photo
//            'picture' => null,
        ]);
    }
}
